            ...
            <div class="d-flex" id="wrapper">
                ...
                <div id="page-content-wrapper">
                    ...
                    <body>
                        ...
                        <form action="editProduct" method="post" style="max-width: 600px;margin-left: 220px;">
                            <div class="card-body p-4 p-sm-5">
                                <h3 style="margin-left: 150px; margin-bottom: 30px;">Chỉnh sửa sản phẩm</h3>

                                <c:forEach items="${pList}" var="p">

                                    <div class="form-floating mb-3" style="background-color: beige;">
                                        <input value="${p.productId}" name="product_id" type="text" class="form-control"
                                            readonly required style="background-color: beige;">
                                        <label for="floatingInputEmail">ID sản phẩm</label>
                                    </div>

                                    <hr>
                                    <div class="form-floating mb-3">
                                        <input value="${p.productName}" name="product_name" type="text"
                                            class="form-control">
                                    ...
                                    <hr>
                                    <div class="form-floating mb-3">
                                        <input value="${p.img}" name="img" type="text" class="form-control">
                                    ...
                                    <div class="form-floating mb-3">
                                        <input value="${p.price}" name="price" type="text" class="form-control">
