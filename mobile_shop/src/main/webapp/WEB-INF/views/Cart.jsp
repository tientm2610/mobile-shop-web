            ...
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    <div class="d-flex flex-wrap justify-content-between align-items-center pb-4">
                        ...
                        <button type="button" class="btn btn-lg btn-primary mt-2" style="background-color: black; "><a
                                style="text-decoration: none; color: inherit;" href="payment">Tiến Hành Thanh Toán</a>
                        </button>
                        <div class="d-flex">
